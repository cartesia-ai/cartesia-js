...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: Cartesia): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: Cartesia): Logger {
